...
source: "Skool Post #29 — AI Profit Lab (Dan B)"
date: 2026-06-11
url: https://www.skool.com/ai-profit-lab-7462/classroom/9daf24e1?md=6c37ee39c3604e73aa791d74fae3462f
tags:
  - hermes-agent
  - automation
  - ai-agents
...
# 11th June: Automation Blueprints
...
> Here are 5 automation blueprints you can set up today.
...
| Resource | URL |
|----------|-----|
| Automation Templates Docs | https://hermes-agent.nousresearch.com/docs/guides/automation-templates |
...
> 💡 **Pro tip:** Want to skip collecting 5 different API keys? Run `hermes setup --portal` and one Nous Portal subscription covers models, web search, image generation and more.
...
- `coder chat` → talks to your coding agent
- `research chat` → talks to your research agent
...
> So the more you use it, the better it gets at **YOUR** workflows.

You can also browse ready-made Hub or type `/skills` to see what's installed.

---

## Blueprint 5: The Parallel Worker (Subagents)

For big jobs, Hermes can spawn isolated subagents that work in parallel.

**Example:** one subagent researches, one writes, one reviews. All at the same time.
...
- [[Skool Post 28 — Loop Engineering]] — _(previous related post)_
- [[Skool Post 27 — Hermes Shopping Assistant]] — _(payments & browser automation)_
